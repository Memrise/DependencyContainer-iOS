...
@objc open class DefaultLegacyDependencyAssembler: NSObject, LegacyDependencyAssembler {
    ...
    static public func create(withType: AnyClass,
                              andBlock:@escaping (_ container: DependencyContainer) -> AnyObject)
        -> DefaultLegacyDependencyAssembler {
    ...
    public func setupInstance(_ instance: AnyObject, with container: DependencyContainer) {
        //unused
    }
}
